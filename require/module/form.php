...
function InputOptions($data, $default = true)
{
        $RegOptions = $data;
        $Count = 0;
...
{ ?>
        <tr>
                <td colspan="<?php echo $columns; ?>" align="center">
...
//function to view editor textarea 
function TextArea($name, $value = null, $rows = 3, array $attributes = null, $id = null)
{
        //value
        if ($value == null) {
                $ReturnValue = "";
...
?>
        ...
        <textarea id="<?php echo $id; ?>" name="<?php echo $name; ?>" rows="<?php echo $rows; ?>" <?php echo $attibute; ?>><?php echo $ReturnValue; ?></textarea>
<?php
}
