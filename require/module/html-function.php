...
function CallTypes($calltype)
{
 if ($calltype == 1) {
  ...
  echo "<span class='text-info'><img src='" . ActionDeleteImage . "' class='list-icon pro-img'></span>";
 } else if ($calltype == 3) {
  echo "<span class='text-danger'><img src='" . STORAGE_URL_D . "/tool-img/missed.png' class='list-icon pro-img'></span>";
 } else {
  echo "<span class='text-danger'><img src='" . STORAGE_URL_D . "/tool-img/missed.png' class='list-icon pro-img'></span>";
 }
}
...
//selecte options with default selected values
function OptionWithPreSelected(array $options, $selected_value = null)
{
