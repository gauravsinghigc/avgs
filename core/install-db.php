...
$save = mysqli_query($DBConnection, $branches);

$branchesinsert = "INSERT IGNORE INTO `branches` (`BranchesId`, `BrancheName`, `BrancheStreetAddress`, `BrancheStreetAddress2`, `BrancheCity`, `BrancheState`, `BranchePincode`, `BrancheContactPerson`, `BranchePhone`, `BrancheFaxNumber`, `BrancheEmailid`, `BrancheGSTNO`, `Brancheisdefault`, `BrancheCreatedAt`, `BrancheUpdatedAt`, `BrancheStatus`, `BranchCode`, `BrancheWebsite`) VALUES
...
";
$save = mysqli_query($DBConnection, $branchesinsert);


//calls
$callstable = "CREATE TABLE IF NOT EXISTS `calls` (
...
$callstablequery = mysqli_query($DBConnection, $callstable);

//configurations
$configstables = "CREATE TABLE IF NOT EXISTS `configurations` (
...
$configsquery = mysqli_query($DBConnection, $configstables);

$configsdata = "INSERT IGNORE INTO `configurations` (`configurationsid`, `configurationname`, `configurationvalue`, `configurationtype`, `configurationsupportivetext`) VALUES
...
$configdataquery = mysqli_query($DBConnection, $configsdata);


//configs invoices
$configinvoicestable = "CREATE TABLE IF NOT EXISTS `config_invoices` (
...
$configinvoicetablesquery = mysqli_query($DBConnection, $configinvoicestable);


$configinvoicestabledata = "INSERT IGNORE INTO `config_invoices` (`ConfigInvoiceId`, `InvoiceConfigName`, `InvoiceConfigValue`) VALUES
...
$configinvoicetabledataquery = mysqli_query($DBConnection, $configinvoicestabledata);
...
$currenciesquery = mysqli_query($DBConnection, $currencies);

$currenciesdata = "INSERT IGNORE INTO `currencies` (`currenciesid`, `currencycode`, `currencysymbole`, `currencyname`, `currenciedecimalplaces`, `currencyformates`, `currencydefault`) VALUES
(1, 'Exercitationem animi', 'Voluptatem assumend', 'Ursa Rosario', '3', '0, 000, 000.00', '')";

$currenciesdata = mysqli_query($DBConnection, $currenciesdata);
...
$customers = mysqli_query($DBConnection, $customers);

//billing address
$bilingsaddrs = "CREATE TABLE IF NOT EXISTS `customer_billing_address` (
...
$bilingsaddrs = mysqli_query($DBConnection, $bilingsaddrs);

//contact persons
$contactperson = "CREATE TABLE IF NOT EXISTS `customer_contact_person` (
...
$contactperson = mysqli_query($DBConnection, $contactperson);

//shipping address
$shippingaddress = "CREATE TABLE IF NOT EXISTS `customer_shipping_address` (
...
$shippingaddress = mysqli_query($DBConnection, $shippingaddress);
...
$deals = mysqli_query($DBConnection, $deals);


//dealsstage
$dealsstage = "CREATE TABLE IF NOT EXISTS `dealstages` (
...
$dealsstage = mysqli_query($DBConnection, $dealsstage);


//deal activities
$dealactivities = "CREATE TABLE IF NOT EXISTS `deal_activities` (
...
$dealactivities = mysqli_query($DBConnection, $dealactivities);


//deals products
$dealproducts = "CREATE TABLE IF NOT EXISTS `deal_products` (
...
$dealproducts = mysqli_query($DBConnection, $dealproducts);
...
$events = mysqli_query($DBConnection, $events);
...
$invoices = mysqli_query($DBConnection, $invoices);
...
$products = mysqli_query($DBConnection, $products);


//productpackages
$productpkg = "CREATE TABLE IF NOT EXISTS `product_packages` (
...
$productpkg = mysqli_query($DBConnection, $productpkg);

//prdocut specifications group 
$progroups = "CREATE TABLE IF NOT EXISTS `product_specifications_groups` (
...
$progroups = mysqli_query($DBConnection, $progroups);

//pro specification group categories
$prospccategories = "CREATE TABLE IF NOT EXISTS `product_specification_categories` (
...
$prospccategories = mysqli_query($DBConnection, $prospccategories);


//prosvalues
$prosvalues = "CREATE TABLE IF NOT EXISTS `product_specification_values` (
...
$prosvalues = mysqli_query($DBConnection, $prosvalues);


//pro brands
$probrands = "CREATE TABLE IF NOT EXISTS `pro_brands` (
...
$probrands = mysqli_query($DBConnection, $probrands);

//probrands  = data
$probrandsdata = "INSERT IGNORE INTO `pro_brands` (`ProBrandId`, `ProBrandName`, `ProBrandStatus`, `ProBrandCreatedAt`, `ProBrandUpdatedAt`, `ProBrandImage`) VALUES
(1, 'Test Braand', '1', '24 Jan, 2022', '', 'brands_Test Braand_24_Jan_2022_09_01_05.jpg')";

$probrandsdata = mysqli_query($DBConnection, $probrandsdata);


//procat
$procat = "CREATE TABLE IF NOT EXISTS `pro_categories` (
...
$procat = mysqli_query($DBConnection, $procat);

$procatdata = "INSERT IGNORE INTO `pro_categories` (`ProCategoriesId`, `ProCategoryName`, `ProCategoryImage`, `ProCategoryStatus`, `ProCategoryCreatedAt`, `ProCategoryUpdatedAt`) VALUES
(1, 'Test Chalu', 'Category__Test Chalu_24_Jan_2022_09_01_07.jpg', '1', '24 Jan, 2022', '')";

$procatdata = mysqli_query($DBConnection, $procatdata);

//proimg
$proimg = "CREATE TABLE IF NOT EXISTS `pro_images` (
...
$proimg = mysqli_query($DBConnection, $proimg);
...
$prosubdata = "INSERT IGNORE INTO `pro_sub_categories` (`ProSubCategoriesId`, `ProSubCategoryName`, `ProSubCategoryId`, `ProSubCategoryImage`, `ProSubCategoryStatus`, `ProSubCategoryCreatedAt`, `ProSubCategoryUpdatedAt`) VALUES
(1, 'Test Chalu 2', '1', 'subcategory_Test Chalu 2_24_Jan_2022_09_01_36.jpg', '1', '24 Jan, 2022', '')";

$prosubdata = mysqli_query($DBConnection, $prosubdata);
...
$quotations = mysqli_query($DBConnection, $quotations);

//qpro 
$qpro = "CREATE TABLE IF NOT EXISTS `quotation_products` (
...
$qpro = mysqli_query($DBConnection, $qpro);

//logs
$logs = "CREATE TABLE IF NOT EXISTS `systemlogs` (
...
$logs = mysqli_query($DBConnection, $logs);
...
$tasks = mysqli_query($DBConnection, $tasks);
...
$users = mysqli_query($DBConnection, $users);

$udata = "INSERT IGNORE INTO `users` (`UserId`, `UserName`, `UserEmailId`, `UserPhone`, `UserPassword`, `UserRoles`, `UserStatus`, `UserProfileImage`, `UserCreatedAt`, `UserUpdatedAt`) VALUES
...
$udata = mysqli_query($DBConnection, $udata);

if ($udata == true) {
 echo "<h1>DB Updated Successfully!</h1><br>
 <a href='../index.php'>View App</a>";
} else {
 echo "<h1>Unable to Update DB</h1><br>
 <a href='install-db.php'>Try Again</a>";
}
