            ...
            <div class="panel-body">
              ...
              <form action="../../../controller/callcontroller.php" method="POST">
                ...
                <div class="row p-1">
                  ...
                  <div class="col-md-5 col-lg-5 col-sm-5 col-12 col-xs-12">
                    <input type="date" name="CallingDate" value="<?php echo date("Y-m-d"); ?>" class="form-control-2" required="">
                  </div>
                </div>
                <div class="row p-1">
                  <div class="col-md-4 col-lg-4 col-sm-5 col-12 col-xs-12">
                  ...
                  <div class="col-md-5 col-lg-5 col-sm-5 col-12 col-xs-12">
                    <input type="time" name="CallingTime" value="<?php echo date("h:m"); ?>" class="form-control-2" required="">
                  </div>
                </div>
                <div class="row p-1">
                  ...
                  <div class="col-md-5 col-lg-5 col-sm-5 col-12 col-xs-12">
                    <textarea name="CallingNotes" id="editor" class="form-control-2" rows="4"></textarea>
                  </div>
                </div>
                <div class="row p-1">
                  <div class="col-md-12 text-center">
                    <button class="btn app-btn" type="Submit" name="CreateNewCalls">Create Call</button>
                    <a target="_blank" href="<?php echo DOMAIN; ?>/admin/activity/calls/" class="btn btn-lg btn-danger">Cancel & Back to All</a>
                  </div>
                </div>
              </form>
            </div>
