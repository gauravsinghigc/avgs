...
//page activities
$PageSqls = "SELECT * FROM customer_billing_address WHERE CustomerBillingAddress='$addressid'";
?>
...
<head>
  ...
  <title>Edit Billing Address | <?php echo APP_NAME; ?></title>
                  ...
                  <form action="../../../controller/customercontroller.php" class="p-1r" method="POST">
                    ...
                    <div class="row">
                      <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
                        <h4 class="app-sub-heading">Billing Address</h4>
                        <label>Street Address</label>
                        <textarea name="CustomerStreetAddress" id="Address1" class="form-control" style="height:100% !important;line-height:100% !important;" rows="4" required=""><?php echo SECURE(GET_DATA("CustomerStreetAddress"), "d"); ?></textarea>
                      </div>
                      <div class="form-group col-lg-6 col-md-6 col-sm-6 col-6">
                        <label>City</label>
                        <input name="CustomerCity" list="city" value="<?php echo GET_DATA("CustomerCity"); ?>" id="Address2" class="form-control" type="text" required="" placeholder="">
                        <datalist id="city">
                      ...
                      <div class="form-group col-lg-6 col-md-6 col-sm-6 col-6">
                        <label>State</label>
                        <input name="CustomerState" value="<?php echo GET_DATA("CustomerState"); ?>" list="states3" id="Address3" class="form-control" type="text" required="" placeholder="">
                        <datalist id="states3">
                      ...
                      <div class="form-group col-lg-6 col-md-6 col-sm-6 col-6">
                        <label>Country</label>
                        <input name="CustomerCountry" value="<?php echo GET_DATA("CustomerCountry"); ?>" id="Address4" class="form-control" type="text" required="" placeholder="">
                      </div>
                      <div class="form-group col-lg-6 col-md-6 col-sm-6 col-6">
                        <label>Zip Code/Pincode</label>
                        <input name="CustomerPincode" value="<?php echo GET_DATA("CustomerPincode"); ?>" id="Address5" class="form-control" type="text" required="" placeholder="">
                      </div>
                    </div>

                    <div class="row">
                      <div class="col-md-12 m-t-10">
                        <button type="submit" name="UpdateAddress" value="<?php echo SECURE($addressid, "e"); ?>" class="app-btn btn">Update Address</button>
                        <a href="index.php" class="btn btn-lg btn-default">Back to Profile</a>
                        <?php CONFIRM_DELETE_POPUP(
                          "delete_address",
                          [
                            "delete_billing_Address" => true,
