        ...
        <div id="page-content">
          ...
          <div class="panel">
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <a href="#" onclick="Databar('AddSubcategories')" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Add Sub Categories</a>
                </div>
                <div class="col-md-12">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group-sm">
                            <a onclick="Databar('edit_<?php echo $ProSubCategoriesId; ?>')" class="btn-sm btn btn-info"><i class="fa fa-edit"></i> Edit</a>
                            <?php if ($CountProducts == 0) { ?>
                              <a href="<?php echo DOMAIN; ?>/controller/productscontroller.php?delete_sub_categories=<?php echo SECURE($ProSubCategoriesId, 'e'); ?>&access_url=<?php echo SECURE(RUNNING_URL, 'e'); ?>&control_id=<?php echo SECURE($ProSubCategoriesId, 'e'); ?>" class="btn-sm btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                            <?php } ?>
                          </div>
                        </td>
                      </tr>
