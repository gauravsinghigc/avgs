        ...
        <div id="page-content">
          ...
          <div class="panel">
            <div class="panel-body">
              <div class="row">
                <div class="col-md-12">
                  <h4 class="app-heading">All Publications</h4>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <a href="#" onclick="Databar('Addbrands')" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Publications</a>
                </div>
                <div class="col-md-12">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group-sm">
                            <a onclick="Databar('edit_<?php echo $ProBrandId; ?>')" class="btn-sm btn-info btn"><i class="fa fa-edit"></i> Edit</a>
                            <?php if ($CountProducts == 0) { ?>
                              <a href="<?php echo DOMAIN; ?>/controller/productscontroller.php?delete_brands=<?php echo SECURE("true", 'e'); ?>&access_url=<?php echo SECURE(RUNNING_URL, 'e'); ?>&control_id=<?php echo SECURE($ProBrandId, "e"); ?>" class="btn-sm btn btn-danger"><i class="fa fa-trash"></i> Delete</a>
                            <?php } ?>
                          </div>
                        </td>
                      </tr>
                            ...
                            <div class="main-data">
                              <div class="main-data-header app-bg">
                                <div class="flex-s-b app-heading">
                                  <h4 class="mt-0 mb-0">Update Publications Details</h4>
                              ...
                              <div class="main-data-body p-2">
                                <div class="row">
                                  <div class="form-group col-lg-6 col-md-6 col-ms-6 col-12">
                                    <label>Enter New Publications Name</label>
                                  ...
                                  <div class="form-group col-lg-6 col-md-6 col-ms-6 col-12">
                                    <label>Upload Publication Image</label>
