...
$CustomerDisplayName = FETCH("SELECT * FROM customers where CustomerId='$QuotationReceiver'", "CustomerDisplayName", true);
?>
<?php
...
<head>
  ...
  <title><?php echo FETCH("SELECT * FROM quotations where QuotationId='$quotationquotoid'", "QuotationNo"); ?>@<?php echo APP_NAME; ?></title>
  ...
  <section class="print-area">
    <div class="app-intro">
      ...
      <div class="performa-details">
        ...
        <h3 style="margin-top:0px;text-align:right"><b>#</b> <?php echo GET_DATA("InvoiceNumber"); ?></h3>
    ...
    <p style="font-size:0.85rem;color:#000;">
      <?php echo html_entity_decode(SECURE(GetInvoiceFeilds("INVOICE_PAYMENT_OPTION_FIELDS"), "d")); ?>
    </p>
    <div class="app-intro">
      <style>
        p {
      ...
      <div style="width:60%;">
        <?php echo html_entity_decode(SECURE(GetInvoiceFeilds("INVOICE_FOOTER_TNC"), "d")); ?>
      </div>
