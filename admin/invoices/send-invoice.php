       ...
       <div class="row m-t-10">
        <div class="col-md-6">
         <form action="../../controller/ordercontroller.php" method="POST">
          ...
          <div class="form-group">
           <p class="text-danger"><b>*</b> Invoice is already attached with the mails. No need to search and attach invoice</p>
           <span class="btn bt-lg btn-info"><i class="fa fa-check-circle-o"></i> Attahced Invoice No : <?php echo FETCH("SELECT * FROM invoices where invoicesid='$invoiceid'", "InvoiceNumber"); ?></span>
          </div>
          <div class="form-group">
          ...
          <div class="">
           <button type="submit" name="SendInvoiceMail" class="btn app-btn">Send Mail</button>

           <a target="_blank" href="index.php" class="btn btn-lg btn-default">Back to All</a>
          </div>
         </form>
        </div>
        <div class="col-md-6">
