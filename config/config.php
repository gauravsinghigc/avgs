...
define("LOCAL_HOST", array("127.0.0.1", "::1", "localhost", "192.168.1.9", "192.168.43.14", "192.168.1.92", "192.168.29.14", "192.168.0.80"));

//filter domain from local or live server
if (in_array("" . HOST . "", LOCAL_HOST)) {
  define("DOMAIN", $link . HOST . "/avgs");
} else {
...
define("TAX_NO", CONFIG("TAX_NO"));
define("GOC_CONFIG_DATE", CONFIG("GOC_CONFIG_DATE"));
